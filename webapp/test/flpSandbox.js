		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#myuifirstappmyfirstproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myuifirstappmyfirstproject-display": {
								"semanticObject": "myuifirstappmyfirstproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=my.ui.firstapp.myfirstproject",
									"url": sap.ui.require.toUrl("my/ui/firstapp/myfirstproject")
								}
							}
						}
					}
